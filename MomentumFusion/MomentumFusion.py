# MomentumFusion
# Мульти-таймфрейм стратегия на основе моментума. Комбинирует сигналы с 1m, 5m, 15m для подтверждения тренда.
# Type: Momentum | Timeframe: 1m, 5m, 15m | ML: False

from freqtrade.strategy import IStrategy, DecimalParameter, IntParameter
import pandas as pd
import talib.abstract as ta

class MomentumFusion(IStrategy):
    timeframe = '1m'
