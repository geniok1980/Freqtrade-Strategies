# VolumeSpikeHunter
# Охота за объёмными всплесками. Срабатывает на аномальные всплески объёма с ML-подтверждением направления.
# Type: Volume | Timeframe: 1m, 5m | ML: True

from freqtrade.strategy import IStrategy, DecimalParameter, IntParameter
import pandas as pd
import talib.abstract as ta

class VolumeSpikeHunter(IStrategy):
    timeframe = '1m'
