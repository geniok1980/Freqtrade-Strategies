# SmartScalpAI
# Интеллектуальный скальпинг с ML-предсказанием импульсов. Использует градиентный бустинг для фильтрации ложных входов.
# Type: Scalping | Timeframe: 1m, 5m | ML: True

from freqtrade.strategy import IStrategy, DecimalParameter, IntParameter
import pandas as pd
import talib.abstract as ta

class SmartScalpAI(IStrategy):
    timeframe = '1m'
