# MeanReversionPro
# Mean reversion с адаптивными полосами Боллинджера и ML-фильтром ложных пробоев.
# Type: Mean Reversion | Timeframe: 5m, 15m | ML: True

from freqtrade.strategy import IStrategy, DecimalParameter, IntParameter
import pandas as pd
import talib.abstract as ta

class MeanReversionPro(IStrategy):
    timeframe = '5m'
