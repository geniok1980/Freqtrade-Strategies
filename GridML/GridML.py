# GridML
# Адаптивная сетка с ML-корректировкой уровней. Динамически подстраивает сетку ордеров под волатильность на основе LSTM.
# Type: Grid | Timeframe: 15m, 1h | ML: True

from freqtrade.strategy import IStrategy, DecimalParameter, IntParameter
import pandas as pd
import talib.abstract as ta

class GridML(IStrategy):
    timeframe = '15m'
